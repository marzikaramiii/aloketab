...
<div class="body">
    ...
    <div class="form" >
        <h3 style="font-weight: normal">ثبت نام در الو کتاب</h3>
        <form action="loginkamel.php" method="post" name="register">
            <div >
                <label>
                    آدرس ایمیل:
                </label>
        ...
        <h3 style="border:none;font-size:15px;display: inline-block;">
            قبلا درالوکتاب ثبت‌نام کرده‌اید؟
        </h3>
       <a href="login.php" style="text-decoration: none;" > <span class="under">وارد شوید</span></a>
    </div>
</div>
<style>
    footer{
